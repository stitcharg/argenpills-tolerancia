export default {
	...
	"background": {
		"primaryGradient": "#000000 linear-gradient(180deg, --color-primary, transparent) 0 0 no-repeat",
		"secondaryGradient": "#000000 linear-gradient(180deg,--color-dark 0%,transparent 100%) 0 0 no-repeat"
	},
	"transform": {
